<template>
  <el-containter>
    ...
    <el-table
      :data="tableData"
      style="width: 1580px; height: 900px;"
      row-key="id"
      stripe
      height="400"
      border
    >
      ...
      <el-table-column prop="result" :label="table_res_text" width="700"/>
      <el-table-column prop="image" :label="table_image_url_text" width="200">
      ...
      <el-table-column prop="entry" :label="table_vqa_entry_text" width="200">
        <template #default="scope">
          <el-button 
